...
/** 
 * @author google, for the most part, with a little modification from Kris
 */
public class AddItemActivity extends FragmentActivity implements ActionBar.TabListener {
  ...
  public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
      ...
      return FragmentChooser.getFragmentByPosition(position);
    }
